...
TGraphAsymmErrors *FULLGRAPH(TH1F *hCentral) {
  
  TGraphAsymmErrors *gr;
  //int n1 = hJESPlus->GetNbinsX(); int n2 = hJESMinus->GetNbinsX();
  //int n1 = 10; int n2 = 10;
  int n1 = hCentral->GetNbinsX(); int n2 = hCentral->GetNbinsX();
...
TGraphAsymmErrors *RATIOGRAPH(TH1F *hCentral) {
...
void example_stack(TString histname, TString xaxis_title, int bin, bool log=false, bool drawdata=true, bool ratio=false, bool drawsignal=false, bool axisrange=false, double xmin=0, double xmax=10,bool label=false )
{
  ...
  TString inFile("/home/ravindra/lxplus/stackhisto/13TeV/outputDir/");
  ...
  TFile* f2 = TFile::Open(inFile+"TTJets_MuMC_20170409_Ntuple_Merged_Anal.root");
...
/*
  ...
  TString inFile_noniso("/home/ravindra/lxplus/stackhisto/13TeV/outputDir/");
  ...
  TFile *wjet_noniso = new TFile(inFile_noniso+"TTJets_MuMC_20170409_Ntuple_Merged_Anal.root");
  ...
  TFile *zjet_noniso = new TFile(inFile_noniso+"TTJets_MuMC_20170409_Ntuple_Merged_Anal.root");
 ...
 */ 
  ...
  leg->AddEntry(h1_base,"HplusM120","F");
  leg->AddEntry(h2_base,"TTJets","F");
/*
...
*/  
  ...
  if(histname.Contains("mjj_kfit_Id_probfit1")) {
   ...
   TText *text = pt->AddText("CMS Preliminary,    #sqrt{s} = 13 TeV,    19.7 fb^{-1}");
  ...
  if(ratio){
    ...
    hRatio->GetYaxis()->SetRangeUser(-5.5, 5.5);
...
void example_stack_all(){
  ...
  /*
  example_stack("pt_mu", "pt_mu", 1, true, true, true, true, false, 0, 5, false);
  example_stack("eta_mu", "eta_mu", 1, true, true, true, true, false, 0, 5, false);
  example_stack("pt_jet", "pt_jet", 1, true, true, true, true, false, 0, 5, false);
  example_stack("eta_jet", "pt_jet", 1, true, true, true, true, false, 0, 5, false);
  example_stack("multi_jet", "multi_jet", 1, true, true, true, true, false, 0, 5, false);
  */
  example_stack("nvtx", "nvtx", 1, true, true, true, true, false, 0, 5, false);
  example_stack("Pre_RelIso", "Pre_RelIso", 1, true, true, true, true, false, 0, 5, false);
