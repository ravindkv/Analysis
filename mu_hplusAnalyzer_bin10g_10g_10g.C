...
void hplusAnalyzer::CutFlowProcessor(TString url,  string myKey, TString cutflowType, TFile *outFile_){
  ...
  for(int i=0; i<nEntries; ++i){
    ...
    */
    ...
    if(pt_bjetHad >= 35 && pt_bjetHad < 45)                         
      fillHisto(outFile_, cutflowType_, "PtbJetInc", "mjj_kfit_35To45", 200, 0, 1000, diJet.mass(), evtWeight );
    if(pt_bjetHad >= 45 && pt_bjetHad < 55)                         
      fillHisto(outFile_, cutflowType_, "PtbJetInc", "mjj_kfit_45To55", 200, 0, 1000, diJet.mass(), evtWeight );
    if(pt_bjetHad >= 55 && pt_bjetHad < 65)                         
      fillHisto(outFile_, cutflowType_, "PtbJetInc", "mjj_kfit_55To65", 200, 0, 1000, diJet.mass(), evtWeight );
    if(pt_bjetHad >= 65 && pt_bjetHad < 75)                         
      fillHisto(outFile_, cutflowType_, "PtbJetInc", "mjj_kfit_65To75", 200, 0, 1000, diJet.mass(), evtWeight );
    if(pt_bjetHad >= 75 && pt_bjetHad < 85)                         
      fillHisto(outFile_, cutflowType_, "PtbJetInc", "mjj_kfit_75To85", 200, 0, 1000, diJet.mass(), evtWeight );
    if(pt_bjetHad >= 85 && pt_bjetHad < 95)                         
      fillHisto(outFile_, cutflowType_, "PtbJetInc", "mjj_kfit_85To95", 200, 0, 1000, diJet.mass(), evtWeight );
    if(pt_bjetHad >= 95 && pt_bjetHad < 105)                         
      fillHisto(outFile_, cutflowType_, "PtbJetInc", "mjj_kfit_95To105", 200, 0, 1000, diJet.mass(), evtWeight );
    if(pt_bjetHad >= 105 && pt_bjetHad < 150)                         
      fillHisto(outFile_, cutflowType_, "PtbJetInc", "mjj_kfit_105To150", 200, 0, 1000, diJet.mass(), evtWeight );
    if(pt_bjetHad >= 150 && pt_bjetHad < 500)                         
      fillHisto(outFile_, cutflowType_, "PtbJetInc", "mjj_kfit_150To500", 200, 0, 1000, diJet.mass(), evtWeight );
    ////////////////////////////////////////////////////
    ...
    if(isCTagT_SF){ 
      ...
      if(pt_bjetHad >= 35 && pt_bjetHad < 45)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_35To45", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 45 && pt_bjetHad < 55)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_45To55", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 55 && pt_bjetHad < 65)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_55To65", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 65 && pt_bjetHad < 75)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_65To75", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 75 && pt_bjetHad < 85)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_75To85", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 85 && pt_bjetHad < 95)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_85To95", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 95 && pt_bjetHad < 105)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_95To105", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 105 && pt_bjetHad < 150)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_105To150", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 150 && pt_bjetHad < 500)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_150To500", 200, 0, 1000, diJet.mass(), evtWeight );
      }
      ...
      if(pt_bjetHad >= 35 && pt_bjetHad < 45)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatM", "mjj_kfit_35To45", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 45 && pt_bjetHad < 55)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatM", "mjj_kfit_45To55", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 55 && pt_bjetHad < 65)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatM", "mjj_kfit_55To65", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 65 && pt_bjetHad < 75)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatM", "mjj_kfit_65To75", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 75 && pt_bjetHad < 85)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatM", "mjj_kfit_75To85", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 85 && pt_bjetHad < 95)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatM", "mjj_kfit_85To95", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 95 && pt_bjetHad < 105)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatM", "mjj_kfit_95To105", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 105 && pt_bjetHad < 150)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatM", "mjj_kfit_105To150", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 150 && pt_bjetHad < 500)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatM", "mjj_kfit_150To500", 200, 0, 1000, diJet.mass(), evtWeight );
      }
      ...
      if(pt_bjetHad >= 35 && pt_bjetHad < 45)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatL", "mjj_kfit_35To45", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 45 && pt_bjetHad < 55)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatL", "mjj_kfit_45To55", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 55 && pt_bjetHad < 65)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatL", "mjj_kfit_55To65", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 65 && pt_bjetHad < 75)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatL", "mjj_kfit_65To75", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 75 && pt_bjetHad < 85)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatL", "mjj_kfit_75To85", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 85 && pt_bjetHad < 95)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatL", "mjj_kfit_85To95", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 95 && pt_bjetHad < 105)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatL", "mjj_kfit_95To105", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 105 && pt_bjetHad < 150)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatL", "mjj_kfit_105To150", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 150 && pt_bjetHad < 500)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatL", "mjj_kfit_150To500", 200, 0, 1000, diJet.mass(), evtWeight );
    }
    else{
      ...
      if(pt_bjetHad >= 35 && pt_bjetHad < 45)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_35To45", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 45 && pt_bjetHad < 55)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_45To55", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 55 && pt_bjetHad < 65)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_55To65", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 65 && pt_bjetHad < 75)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_65To75", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 75 && pt_bjetHad < 85)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_75To85", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 85 && pt_bjetHad < 95)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_85To95", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 95 && pt_bjetHad < 105)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_95To105", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 105 && pt_bjetHad < 150)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_105To150", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 150 && pt_bjetHad < 500)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_150To500", 200, 0, 1000, diJet.mass(), evtWeight );
    }
