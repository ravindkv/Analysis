  ...
  for(int i=0; i<nEntries; ++i){
    ...
    */
    ...
    if(isCTagT_SF){ 
      ...
      if(pt_bjetHad >= 25 && pt_bjetHad < 43)
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_25To43", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 43 && pt_bjetHad < 57)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_43To57", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 57 && pt_bjetHad < 74)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_57To74", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 74 && pt_bjetHad < 99)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_74To99", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 99 && pt_bjetHad < 500)                        
        fillHisto(outFile_, cutflowType_, "PtbJetCatT", "mjj_kfit_99To500", 200, 0, 1000, diJet.mass(), evtWeight );
      }
      ...
      if(pt_bjetHad >= 25 && pt_bjetHad < 43)
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_25To43", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 43 && pt_bjetHad < 57)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_43To57", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 57 && pt_bjetHad < 74)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_57To74", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 74 && pt_bjetHad < 99)                         
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_74To99", 200, 0, 1000, diJet.mass(), evtWeight );
      if(pt_bjetHad >= 99 && pt_bjetHad < 500)                        
        fillHisto(outFile_, cutflowType_, "PtbJetCatO", "mjj_kfit_99To500", 200, 0, 1000, diJet.mass(), evtWeight );
    }
