  ...
  void HistogramPlotter::InitHist(TString dirname, TString parentDir, TFile *file)
{
  ...
  addHisto("pt_jet", fullname, 50, 0., 100.);
  ...
  */
  ...
  addHisto("pt_ele", fullname, 50, 0., 100.);
  ...
  addHisto("pt_mu", fullname, 50, 0., 100.);
  ...
  addHisto("pt_tau", fullname, 50, 0., 100.);
  ...
  addHisto("pt_met", fullname, 50, 0., 100.);
  h1 = getHisto("pt_met", fullname);
  h1->SetDirectory(d);
  
  addHisto("final_pt_met", fullname, 50, 0., 100.);
