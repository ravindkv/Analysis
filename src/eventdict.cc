...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::BtagSF*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("BtagSF", ::BtagSF::Class_Version(), "interface/BtagSF.hh", 12,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::UncertaintyComputer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("UncertaintyComputer", ::UncertaintyComputer::Class_Version(), "interface/UncertaintyComputer.hh", 35,
...
"/home/rverma/t3store2/CMSSW_8_0_25/src/Analysis/src/..",
"/cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.06.00-ikhhed6/include",
"/grid_mnt/t3storage2/rverma/CMSSW_8_0_25/src/Analysis/src/",
0
    };
