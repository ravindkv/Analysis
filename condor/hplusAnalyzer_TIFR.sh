...
#------------------------------------------------
echo "OUTPUT: "
ls ${_CONDOR_SCRATCH_DIR}/CMSSW_7_2_1/src/Analysis/13TeV/$outAnalDir

cp -rf ${_CONDOR_SCRATCH_DIR}/CMSSW_7_2_1/src/Analysis/13TeV/$outAnalDir/* /home/rverma/condor_out/histo_MuMC_MuData_20170608_TIFR

#xrdcp -f -R ${_CONDOR_SCRATCH_DIR}/CMSSW_7_2_1/src/Analysis/13TeV/$outAnalDir root://se01.indiacms.res.in:1094//cms/store/user/rverma/histo_MuMC_MuData_20170608_TIFR/
cd ${_CONDOR_SCRATCH_DIR}
rm -rf CMSSW_7_2_1

#/////////// LXPLUS ///////////////////////
#cd /afs/cern.ch/work/r/rverma/private/analysis/CMSSW_7_2_3/src
#cd /home/rverma/t3store2/CMSSW_7_2_1/src/
#source /cvmfs/cms.cern.ch/cmsset_default.sh
#eval `scram runtime -sh`
#echo "CONDOR DIR: $_CONDOR_SCRATCH_DIR"
#cd ${_CONDOR_SCRATCH_DIR}
...
#cp -r /home/rverma/t3store2/CMSSW_7_2_1/src/Analysis .
#cd Analysis
#./runMe.sh $inNtupleFile $outAnalFile $outAnalDir
#echo "OUTPUT: "
