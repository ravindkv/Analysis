...
limitDir="/home/rverma/t3store/AN-18-061/ExclusionLimit/CMSSW_8_0_25/src/HiggsAnalysis/HplusTocs13TeVLimit/Limit"
...
python MyLimitComputer.py --ch $channel --cat $category --mass $massPoint --batch True 
echo "DONE"
date
