...
void compareLimit_13TeV( ){
  ...
  TGraphAsymmErrors* g_mu1 = getLimit("limit/mu/Cat1_Inc","limit_mu_Cat1_Inc.root", "mu+jets", 1, true, false, 0.0, 0.1);
  TGraphAsymmErrors* g_mu2 = getLimit("limit/mu/Cat2_cTagInc","limit_mu_Cat2_cTagInc.root", "mu+jets", 2, true, false, 0.0, 0.1);
  TGraphAsymmErrors* g_mu3 = getLimit("limit/mu/Cat3_cTagEx","limit_mu_Cat3_cTagEx.root", "mu+jets", 3, true, false, 0.0, 0.1);
  c1->cd(1);
  ...
  //electron channel 
  TGraphAsymmErrors* g_ele1 = getLimit("limit/ele/Cat1_Inc","limit_ele_Cat1_Inc.root", "ele+jets", 1, true, false, 0.0, 0.1);
  TGraphAsymmErrors* g_ele2 = getLimit("limit/ele/Cat2_cTagInc","limit_ele_Cat2_cTagInc.root", "ele+jets", 2, true, false, 0.0, 0.1);
  TGraphAsymmErrors* g_ele3 = getLimit("limit/ele/Cat3_cTagEx","limit_ele_Cat3_cTagEx.root", "ele+jets", 3, true, false, 0.0, 0.1);
  ...
  //lepton channel 
  TGraphAsymmErrors* g_lep1 = getLimit("limit/mu_ele/Cat1_Inc","limit_mu_ele_Cat1_Inc.root", "lep+jets", 1, true, false, 0.0, 0.1);
  TGraphAsymmErrors* g_lep2 = getLimit("limit/mu_ele/Cat2_cTagInc","limit_mu_ele_Cat2_cTagInc.root", "lep+jets", 2, true, false, 0.0, 0.1);
  TGraphAsymmErrors* g_lep3 = getLimit("limit/mu_ele/Cat3_cTagEx","limit_mu_ele_Cat3_cTagEx.root", "lep+jets", 3, true, false, 0.0, 0.1);
...
void MyCompareLimits(){
  ...
  double yMin = 0.003;
  double yMax = 0.1;  
  TGraphAsymmErrors* g_mu1 = getLimit("limit/mu/Cat1_Inc","limit_mu_Cat1_Inc.root", "mu+jets", 1, true, false, yMin, yMax);
  TGraphAsymmErrors* g_mu2 = getLimit("limit/mu/Cat2_cTagInc","limit_mu_Cat2_cTagInc.root", "mu+jets", 3, true, false, yMin, yMax);
  TGraphAsymmErrors* g_mu3 = getLimit("limit/mu/Cat3_cTagEx","limit_mu_Cat3_cTagEx.root", "mu+jets", kYellow+1, true, false, yMin, yMax);

  //electron channel 
  TGraphAsymmErrors* g_ele1 = getLimit("limit/ele/Cat1_Inc","limit_ele_Cat1_Inc.root", "ele+jets", 6, true, false, yMin, yMax);
  TGraphAsymmErrors* g_ele2 = getLimit("limit/ele/Cat2_cTagInc","limit_ele_Cat2_cTagInc.root", "ele+jets", 29, true, false, yMin, yMax);
  TGraphAsymmErrors* g_ele3 = getLimit("limit/ele/Cat3_cTagEx","limit_ele_Cat3_cTagEx.root", "ele+jets", kRed+1, true, false, yMin, yMax);
  
  //lepton channel 
  TGraphAsymmErrors* g_lep1 = getLimit("limit/mu_ele/Cat1_Inc","limit_mu_ele_Cat1_Inc.root", "lep+jets", kCyan, true, false, yMin, yMax);
  TGraphAsymmErrors* g_lep2 = getLimit("limit/mu_ele/Cat2_cTagInc","limit_mu_ele_Cat2_cTagInc.root", "lep+jets", 39, true, false, yMin, yMax);
  TGraphAsymmErrors* g_lep3 = getLimit("limit/mu_ele/Cat3_cTagEx","limit_mu_ele_Cat3_cTagEx.root", "lep+jets", kBlue, true, false, yMin, yMax);
