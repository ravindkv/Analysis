...
void LimitPlotter(TString CHANNEL="mu", TString CAT= "Cat1_Inc",
  ...
  TString massFiles [7] = {
  "Mass90/higgsCombineChargedHiggs_"+ch_hist+".AsymptoticLimits.mH90.root",
  "Mass100/higgsCombineChargedHiggs_"+ch_hist+".AsymptoticLimits.mH100.root",
  "Mass120/higgsCombineChargedHiggs_"+ch_hist+".AsymptoticLimits.mH120.root",
  "Mass140/higgsCombineChargedHiggs_"+ch_hist+".AsymptoticLimits.mH140.root",
  "Mass150/higgsCombineChargedHiggs_"+ch_hist+".AsymptoticLimits.mH150.root",
  "Mass155/higgsCombineChargedHiggs_"+ch_hist+".AsymptoticLimits.mH155.root",
  "Mass160/higgsCombineChargedHiggs_"+ch_hist+".AsymptoticLimits.mH160.root"};

  for(unsigned int i = 0 ; i < nMassPoints; i++){
    cout<<"limit/"+CHANNEL+"/"+CAT+"/"<<massFiles[i]<<endl;
    TFile f("limit/"+CHANNEL+"/"+CAT+"/"+massFiles[i],"READ"); // higgsCombineChargedHiggs_mu.AsymptoticLimits.mH140.root
    if(f.IsZombie()){
...
void MyLimitPlotter(){
  double yRange = 0.03;  
  /*
  LimitPlotter("mu", "Cat1_Inc",              yRange, false, true );
  LimitPlotter("mu", "Cat2_bJetPtBin",        yRange, false, true );
  LimitPlotter("mu", "Cat3_cTagInc",          yRange, false, true );
  LimitPlotter("mu", "Cat4_cTagEx",           yRange, false, true );
  LimitPlotter("mu", "Cat5_cTagEx_bJetPtBin", yRange, false, true );
  */

  LimitPlotter("ele", "Cat1_Inc",              yRange, false, true );
  /*
  LimitPlotter("ele", "Cat2_bJetPtBin",        yRange, false, true );
  LimitPlotter("ele", "Cat3_cTagInc",          yRange, false, true );
  LimitPlotter("ele", "Cat4_cTagEx",           yRange, false, true );
  LimitPlotter("ele", "Cat5_cTagEx_bJetPtBin", yRange, false, true );
  */

  /*
  LimitPlotter("mu_ele", "Cat1_Inc",              yRange, false, true );
  LimitPlotter("mu_ele", "Cat2_bJetPtBin",        yRange, false, true );
  LimitPlotter("mu_ele", "Cat3_cTagInc",          yRange, false, true );
  LimitPlotter("mu_ele", "Cat4_cTagEx",           yRange, false, true );
  LimitPlotter("mu_ele", "Cat5_cTagEx_bJetPtBin", yRange, false, true );
  */
}
