...
TH1F* ttbar_scaleUp_ = readWriteHisto(fTT_up, "base/Iso/KinFit/", histname, 1, fout, "ttbar_scaleUp", false);
...
TH1F* ttbar_scaleUp = readWriteHisto(fTT_up, "base/Iso/KinFit/", histname, sf_ttbar_scaleUp, fout, "ttbar_scaleUp", true);
...
TH1F* ttbar_scaleDown_ = readWriteHisto(fTT_down, "base/Iso/KinFit/", histname, 1, fout, "ttbar_scaleDown", false);
...
TH1F* ttbar_matchingUp_ = readWriteHisto(fTT_hdampUP, "base/Iso/KinFit/", histname, 1, fout, "ttbar_matchingUp", false);
...
TH1F* ttbar_matchingUp = readWriteHisto(fTT_hdampUP, "base/Iso/KinFit/", histname, sf_ttbar_matchingUp, fout, "ttbar_matchingUp", true);
...
TH1F* ttbar_matchingDown_ = readWriteHisto(fTT_hdampDOWN, "base/Iso/KinFit/", histname, 1, fout, "ttbar_matchingDown", false);
...
TH1F* ttbar_matchingDown = readWriteHisto(fTT_hdampDOWN, "base/Iso/KinFit/", histname, sf_ttbar_matchingDown, fout, "ttbar_matchingDown", true);
  ...
  while (in.good()){
    ...
    if (in.good()){
      ...
      if(line.find("Date")!=string::npos){
        ...
        line.replace( line.find("XXX") , 3 , string(outShapeFile+"_CHANNEL_"+histname+"_13TeV"));
        out << line << endl;
      }
