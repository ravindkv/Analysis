...
hist_rho    = ROOT.TH1F("rho","rho    ;;#rho ",prefit.getSize(),0,prefit.getSize())
...
if options.plotfile:
    ...
    canvas_nuis = ROOT.TCanvas("nuisancs", "nuisances", 700, 1000)
    ...
    h2_prefit.GetYaxis().SetLabelSize(0.02)   
