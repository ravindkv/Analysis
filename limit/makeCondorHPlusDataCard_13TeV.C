...
void makeOneDataCard(TFile *fWH, int mass=80, TString label="WH80", TString label2="HH80", TString histname = "mjj_kfit"){
  ...
  while (in.good()){
    ...
    if (in.good()){
      ...
      else if(line.find("bTag_lnN")!=string::npos){
      ...
      else if(line.find("cTag_lnN")!=string::npos){
	...
	line.replace( line.find("XXXX") , 4 , string(Form("%.3f", getStatUnc(ttbar,  0))));   
      ...
      else if(line.find("Pileup_lnN")!=string::npos){
      ...
      else if(line.find("JES_lnN")!=string::npos){
      ...
      else if(line.find("JER_lnN")!=string::npos){
      ...
      else if(line.find("topPt_lnN")!=string::npos){
